...
टास्क चेकबॉक्स (\`- [x]\`, \`- [ ]\`) \`<input type="checkbox">\` टैग के माध्यम से रेंडर होते हैं जो डिफ़ॉल्ट रूप से \`View\` पर मैप होता है। कंटेनर को स्टाइल करने के लिए \`styles.gfmTask\` का उपयोग करें, या चेकबॉक्स विज़ुअल को पूरी तरह बदलने के लिए (जैसे वास्तविक \`<Image>\` चेकबॉक्स, एनिमेटेड स्थिति आदि) \`input\` को ओवरराइड करें। आपके ओवरराइड कंपोनेंट को \`checked\`, \`type: 'checkbox'\`, \`readOnly\`, मर्ज की गई \`style\`, और एक डिफ़ॉल्ट \`<Text>\` चाइल्ड मिलता है जो \`[x]\` या \`[ ]\` दिखाता है — यह ओवरराइड न होने पर मार्कर को दृश्य रखता है। मार्कर चाइल्ड लाइब्रेरी द्वारा नियंत्रित है और इसे अलग से स्टाइल नहीं किया जा सकता; जो उपभोक्ता विज़ुअल को पूर्णतः अनुकूलित करते हैं उन्हें इस चाइल्ड को अनदेखा करना चाहिए और \`props.checked\` के आधार पर अपना स्वयं का संकेतक रेंडर करना चाहिए।

टास्क के चारों ओर लिस्ट आइटम रैपर पर डिफ़ॉल्ट रूप से \`flexDirection: 'row'\` और \`alignItems: 'center'\` लागू होते हैं, ताकि चेकबॉक्स और लेबल बिना किसी अतिरिक्त कॉन्फ़िगरेशन के एक ही पंक्ति में दिखें। अपना \`styles.listItem\` पास करके इन्हें ओवरराइड करें — \`mergeStyle\` पंक्ति वाले डिफ़ॉल्ट को नीचे रखता है, इसलिए आप जो भी प्रॉपर्टी सेट करेंगे वह संघर्ष की स्थिति में जीतेगी (जैसे, बहु-पंक्ति लेबल वाले टास्क के लिए \`alignItems: 'flex-start'\` पास करें)।
