import{r as c,j as ge}from"./index-DHEXcuFR.js";function be(i){for(var n=[`fn map(pos: vec3f) -> f32 {
    let k = u.elasticity;
    let p0 = particles[0u];
