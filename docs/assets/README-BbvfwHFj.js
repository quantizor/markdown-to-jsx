const n=`[![npm version](https://badge.fury.io/js/markdown-to-jsx.svg)](https://badge.fury.io/js/markdown-to-jsx) [![downloads](https://badgen.net/npm/dy/markdown-to-jsx)](https://npm-stat.com/charts.html?package=markdown-to-jsx)
...
- [उपयोग](#usage)
  ...
  - [लाइब्रेरी विकल्प](#library-options)
    ...
    - [कच्चा HTML सैनिटाइज़ेशन](#raw-html-sanitization)
...
- \`styles?: NativeStyles\` - प्रत्येक एलिमेंट प्रकार के लिए की-वार स्टाइल ओवरराइड्स। प्रत्येक की अपने लक्ष्य कंपोनेंट के अनुसार संकीर्ण की गई है (इनलाइन सामग्री और शीर्षकों के लिए \`TextStyle\`, कंटेनर के लिए \`ViewStyle\`, इमेज के लिए \`ImageStyle\`)।
- \`wrapperProps?: ViewProps | TextProps\` - रैपर कंपोनेंट के लिए props (ब्लॉक के लिए डिफ़ॉल्ट \`View\`, इनलाइन के लिए \`Text\`)

**डिफ़ॉल्ट स्टाइल:**

React Native आउटपुट एक स्वच्छ, न्यूनतम बेस स्टाइलशीट के साथ आता है ताकि मार्कडाउन बॉक्स से बाहर एक पठनीय पदानुक्रम के साथ रेंडर हो: एक शीर्षक आकार कैस्केड, मोनोस्पेस कोड, ब्लॉक्स के बीच स्पेसिंग, एक ब्लॉककोट रूल, और एक हेडर पंक्ति व संरेखित कॉलम वाली टेबल। सब कुछ अनुकूलन योग्य बना रहता है। \`styles\` में प्रत्येक की उस एलिमेंट के डिफ़ॉल्ट के ऊपर मर्ज होती है, इसलिए एक प्रॉपर्टी सेट करने पर (जैसे \`heading1.color\`) बाकी डिफ़ॉल्ट बना रहता है। \`styles.text\` सभी रेंडर किए गए टेक्स्ट के नीचे लागू होने वाला एक बेस है, इसलिए आप पूरे दस्तावेज़ के लिए एक साथ फ़ॉन्ट, रंग और आकार सेट कर सकते हैं:

\`\`\`tsx
<Markdown options={{ styles: { text: { color: '#333', fontSize: 17 } } }}>{content}</Markdown>
\`\`\`

किसी भी एलिमेंट को उसकी की के ज़रिए ओवरराइड करें। हर की वैकल्पिक है और डिफ़ॉल्ट के ऊपर मर्ज होती है, इसलिए आप केवल वे ही प्रॉपर्टीज़ बदलते हैं जिनका नाम आप लेते हैं:

\`\`\`tsx
<Markdown
  options={{
    styles: {
      heading1: { color: '#b91c1c' }, // एक प्रॉपर्टी बदलें, बाकी डिफ़ॉल्ट बनाए रखें
...
उपलब्ध कीज़, प्रत्येक उसके लक्ष्य कंपोनेंट द्वारा स्वीकृत स्टाइल के अनुसार टाइप की गई (\`TextStyle\`, \`ViewStyle\`, या \`ImageStyle\`):

- टेक्स्ट: \`text\` (सभी रेंडर किए गए टेक्स्ट के नीचे लागू होने वाला बेस), \`paragraph\`, \`heading1\` से \`heading6\` तक, \`link\`, \`footnote\`, \`codeInline\`, \`strong\`, \`em\`, \`del\`, \`mark\`, \`listItemBullet\`, \`listItemNumber\`
- ब्लॉक्स: \`blockquote\`, \`codeBlock\`, \`thematicBreak\`, \`image\`
- सूचियां: \`listOrdered\`, \`listUnordered\`, \`listItem\`
- टेबल्स: \`table\`, \`tableHeader\`, \`tableHeaderCell\`, \`tableHeaderText\` (बोल्ड हेडर टेक्स्ट), \`tableRow\`, \`tableCell\`, \`tableCellDivider\` और \`tableRowDivider\` (ग्रिड लाइनें)
- GFM टास्क: \`gfmTask\` (बना हुआ चेकबॉक्स), \`gfmTaskChecked\` (चेक की गई अवस्था का एक्सेंट फ़िल), \`checkmark\` (चेकमार्क ग्लिफ़)

कच्चे HTML कंटेनर टैग (\`div\`, \`section\`, \`article\`, \`ul\`, \`ol\`, \`li\`, \`th\`, \`td\`, और इसी तरह के) भी अपने ही टैग नाम के तहत एक स्टाइल स्वीकार करते हैं।

किसी एलिमेंट की रेंडरिंग को दोबारा स्टाइल करने के बजाय पूरी तरह बदलने के लिए, \`overrides\` का उपयोग करें। यहाँ styles और overrides को मिलाकर एक पूर्ण रूप से थीम्ड कॉन्फ़िगरेशन है, साथ ही एक \`renderRule\` जो फेंस्ड कोड को सिंटैक्स हाइलाइटर से बदल देता है:
...
<Markdown
  options={{
    styles: {
      text: { color: '#c9d1d9' }, // सभी टेक्स्ट के लिए बेस रंग
...
फेंस्ड कोड ब्लॉक \`<pre><code>\` के रूप में रेंडर होता है, और किसी भी एलिमेंट को फेंस की भाषा नहीं मिलती, इसलिए भाषा-जागरूक कोड रेंडरिंग (सिंटैक्स हाइलाइटिंग, \`\`\`\` \`\`\`latex \`\`\`\` के लिए एक KaTeX ब्लॉक) \`renderRule\` में होनी चाहिए, जहाँ \`node.lang\` और \`node.text\` उपलब्ध हैं।

**ओवरराइड्स (Overrides):**

Native पर ओवरराइड्स वेब के समान काम करते हैं: \`overrides\` की HTML टैग नामों के अनुरूप होती हैं और पार्स की गई मार्कडाउन तथा कच्चे HTML दोनों पर सक्रिय होती हैं। उदाहरण के लिए, \`code\` को ओवरराइड करके इनलाइन बैकटिक्स और फेंस्ड कोड ब्लॉक के आंतरिक एलिमेंट को बदलें, \`pre\` को ओवरराइड करके फेंस्ड कोड को रैप करें, \`input\` को ओवरराइड करके GFM कार्यों के लिए वास्तविक चेकबॉक्स विज़ुअल रेंडर करें, और \`ul\`/\`ol\`/\`li\` को ओवरराइड करके सूची कंटेनर और पंक्तियाँ बदलें। बुलेट और संख्याएँ \`li\` के अंदर लाइब्रेरी द्वारा नियंत्रित रहती हैं।

जब रेंडरर द्वारा दी गई स्टाइल (\`styles.codeInline\`, \`styles.gfmTask\` आदि) और \`overrides[tag].props.style\` दोनों सेट हों, तो वे React Native स्टाइल ऐरे के रूप में मर्ज हो जाती हैं, संघर्ष की स्थिति में ओवरराइड-स्तर की स्टाइलिंग जीतती है।

**GFM टास्क चेकबॉक्स:**

टास्क चेकबॉक्स (\`- [x]\`, \`- [ ]\`) \`<input type="checkbox">\` टैग के माध्यम से रेंडर होते हैं जो डिफ़ॉल्ट रूप से \`View\` पर मैप होता है और एक बना हुआ चेकबॉक्स दिखाता है: एक रूपरेखा वाला बॉक्स जो टास्क पूरा होने पर एक एक्सेंट रंग और एक चेकमार्क से भर जाता है। यह चेकबॉक्स लिस्ट बुलेट की जगह लेता है, जिसे टास्क आइटम्स के लिए दबा दिया जाता है। बॉक्स को दोबारा स्टाइल करने के लिए \`styles.gfmTask\` का उपयोग करें, या विज़ुअल को पूरी तरह बदलने के लिए (जैसे वास्तविक \`<Image>\` चेकबॉक्स, एनिमेटेड स्थिति आदि) \`input\` को ओवरराइड करें। आपके ओवरराइड कंपोनेंट को \`checked\`, \`type: 'checkbox'\`, \`readOnly\`, मर्ज की गई \`style\`, और एक फ़ॉलबैक मार्कर के रूप में \`[x]\` या \`[ ]\` दिखाने वाला एक \`<Text>\` चाइल्ड मिलता है; जो उपभोक्ता विज़ुअल को पूर्णतः अनुकूलित करते हैं उन्हें इस चाइल्ड को अनदेखा करना चाहिए और \`props.checked\` के आधार पर अपना स्वयं का संकेतक रेंडर करना चाहिए।

टास्क के चारों ओर लिस्ट आइटम रैपर पर डिफ़ॉल्ट रूप से \`flexDirection: 'row'\` और \`alignItems: 'flex-start'\` लागू होते हैं, ताकि चेकबॉक्स लेबल की पहली पंक्ति के साथ संरेखित हो; इसके बाद चेकबॉक्स का अपना टॉप मार्जिन उसे उस पंक्ति के सापेक्ष केंद्र में रखता है, जिससे लेबल के अनेक पंक्तियों में लिपटने पर भी वह सही स्थान पर बना रहता है। अपना \`styles.listItem\` पास करके इन्हें ओवरराइड करें: \`mergeStyle\` पंक्ति वाले डिफ़ॉल्ट को नीचे रखता है, इसलिए आप जो भी प्रॉपर्टी सेट करेंगे वह संघर्ष की स्थिति में जीतेगी (जैसे, चेकबॉक्स को पूरे लेबल के सापेक्ष लंबवत रूप से केंद्रित करने के लिए \`alignItems: 'center'\` पास करें)।

**HTML टैग मैपिंग:**
HTML टैग स्वचालित रूप से React Native कंपोनेंट्स पर मैप किए जाते हैं:

- \`<img>\` → \`Image\` कंपोनेंट
- ब्लॉक एलिमेंट्स (\`<div>\`, \`<section>\`, \`<article>\`, \`<blockquote>\`, \`<hr>\`, \`<input>\`, \`<ul>\`, \`<ol>\`, \`<li>\`, \`<table>\`, आदि) → \`View\` कंपोनेंट
- इनलाइन एलिमेंट्स (\`<span>\`, \`<strong>\`, \`<em>\`, \`<a>\`, शीर्षक, \`<code>\`, आदि) → \`Text\` कंपोनेंट
- Type 1 ब्लॉक्स (\`<pre>\`, \`<script>\`, \`<style>\`, \`<textarea>\`) → \`View\` कंपोनेंट

**टेक्स्ट और ब्लॉक्स का मिश्रण:** React Native टेक्स्ट के अंदर किसी इमेज या व्यू को नेस्ट नहीं कर सकता, इसलिए जब कोई इनलाइन कंटेनर (पैराग्राफ़, शीर्षक, ज़ोर (emphasis), या लिंक) किसी इमेज या ब्लॉक-स्तरीय सामग्री को धारण करता है, तो वह \`Text\` के बजाय \`View\` के रूप में रेंडर होता है। उसका टेक्स्ट एक \`Text\` में समूहित किया जाता है ताकि वह एक ही पंक्ति में प्रवाहित होता रहे, इमेज अपने स्वयं के एलिमेंट के रूप में रेंडर होती है, और लिंक के अंदर की इमेज \`Pressable\` के माध्यम से टैप करने योग्य बनी रहती है। केवल-टेक्स्ट वाली सामग्री अप्रभावित रहती है और पहले की तरह रेंडर होती है।
...
**नोट:** फ़ुटनोट संदर्भ मार्कर (\`[^1]\`) सुपरस्क्रिप्ट के रूप में रेंडर होते हैं, जो वेब रेंडरर द्वारा उत्पन्न \`<sup>\` से मेल खाता है। React Native स्टाइल के ज़रिए इनलाइन टेक्स्ट को न ऊपर उठा सकता है न सिकोड़ सकता है (यह इनलाइन टेक्स्ट पर \`verticalAlign\` और ट्रांसफ़ॉर्म को नज़रअंदाज़ करता है), इसलिए संख्यात्मक मार्कर यूनिकोड सुपरस्क्रिप्ट ग्लिफ़ (\`¹²³\`) का उपयोग करते हैं, जिन्हें फ़ॉन्ट स्वयं ही आसपास के टेक्स्ट के सापेक्ष ऊपर उठाकर और उपयुक्त आकार में बनाता है। गैर-संख्यात्मक पहचानकर्ता (\`[^note]\`) सादे टेक्स्ट के रूप में रेंडर होते हैं। मार्कर को \`styles.footnote\` विकल्प के ज़रिए स्टाइल करें।
...
<h4 id="raw-html-sanitization">कच्चा HTML सैनिटाइज़ेशन</h4>

आपके markdown में कच्चा HTML हर रेंडरर (React, React Native, HTML, Markdown, Solid, और Vue) में स्वचालित रूप से सैनिटाइज़ किया जाता है, ताकि अविश्वसनीय इनपुट आपके आउटपुट में कोई स्क्रिप्ट न घुसा सके। यह हमेशा सक्रिय रहता है और \`options.sanitizer\` से स्वतंत्र है, जो केवल URL schemes को नियंत्रित करता है।

रेंडरिंग से पहले हटाया गया:

- इनलाइन इवेंट हैंडलर: \`onclick\`, \`onerror\`, \`onload\`, और कोई भी अन्य \`on*\` एट्रिब्यूट।
- \`href\`, \`src\`, \`action\`, \`formaction\`, \`poster\`, \`cite\`, \`background\`, \`data\`, \`longdesc\`, और \`xlink:href\` में \`javascript:\`, \`vbscript:\`, या गैर-छवि \`data:\` scheme वाले URL एट्रिब्यूट। HTML एंटिटीज़ के पीछे छिपे schemes, जैसे \`java&#9;script:\` या अर्धविराम-रहित \`&#106avascript:\`, को भी डिकोड करके पकड़ा जाता है।
- \`iframe\` का \`srcdoc\` एट्रिब्यूट।

रखा गया: अपने मूल स्वरूप के साथ सुरक्षित एट्रिब्यूट, \`data:image\` URLs, और वे इवेंट हैंडलर जिन्हें आप अपने स्वयं के कंपोनेंट्स को एक्सप्रेशन के रूप में पास करते हैं (\`<MyButton onClick={fn} />\`), साथ ही उन पर सादे बूलियन props (\`<MyButton onClick />\`)। एक चेतावनी: \`data:image/svg+xml\` की अनुमति है लेकिन यह टॉप-लेवल नेविगेशन के रूप में खोले जाने पर स्क्रिप्ट चला सकता है, इसलिए अविश्वसनीय स्रोतों से आए SVG data URLs को सावधानी से संभालें।

खतरनाक टैग नाम (\`script\`, \`iframe\`, \`style\`, और इसी तरह के) [\`tagfilter\`](#all-options) विकल्प द्वारा अलग से एस्केप किए जाते हैं, जो डिफ़ॉल्ट रूप से सक्रिय है।
...
- अपूर्ण टेबल (पहली डेटा पंक्ति से पहले केवल हेडर या डिवाइडर पंक्ति); एक बार टेबल रेंडर हो जाने पर, आगे और पंक्तियाँ आने पर भी वह स्थिर रहती है, इसलिए यह कभी raw पाइप्स नहीं दिखाती या पंक्तियों के बीच झिलमिलाती नहीं है
...
- \`RuleType.htmlBlock\` - HTML ब्लॉक्स और JSX कंपोनेंट्स
  ...
  **नोट:** PascalCase JSX कंपोनेंट्स और हाइफ़नेटेड कस्टम एलिमेंट्स, opening/closing टैग के बीच खाली लाइन आने पर अपने children को nest करते हैं, बजाय बाद की सामग्री को sibling के रूप में लीक करने के। ज्ञात HTML ब्लॉक टैग (\`div\`, \`figure\`, और CommonMark ब्लॉक सेट के बाकी टैग) भी ऐसा ही करते हैं। अज्ञात लोअरकेस टैग अभी भी CommonMark Type 7 का पालन करते हैं और पहली खाली लाइन पर रुक जाते हैं।
