# Contributing to marqdown

First, welcome and thanks so much for your interest in helping to make this library the best it can be!

marqdown (formerly markdown-to-jsx) v9 is a ground-up rewrite of the library to enable highest performance and 100% GFM+CommonMark specification compliance. Here are some general guidelines of what this library looks to solve:
...
marqdown is maintained by a diverse team and seeks to maintain a healthy, inclusive environment for contributors. Any slurs, hate speech, or other aggressions of that nature will not be tolerated and the relevant parties will be blocked from the repository. Zero exceptions, be professional.
